...
use crate::{
    ...
    hash_types::SigHash,
    script::Script,
    transaction::{NullTxOut, SigHashType, Transaction, TxIn, TxInWitness, TxOut},
};
...
impl<R: Deref<Target = Transaction>> SigHashCache<R> {
    ...
    /// Panics if `input_index` is greater than or equal to `self.input.len()`
    ///
    pub fn encode_segwitv0_signing_data_to<Write: io::Write, V: Encodable>(
        &mut self,
        mut writer: Write,
        input_index: usize,
        script_code: &Script,
    ...
    /// Panics if `input_index` is greater than or equal to `self.input.len()`
    ///
    pub fn segwitv0_sighash<V: Encodable>(
        &mut self,
        input_index: usize,
        script_code: &Script,
        value: V,
...
mod tests {
    use super::*;
    use crate::{confidential::ValueCommitment, encode::Decodable, ExplicitValue};
    use bitcoin::hashes::hex::FromHex;
    use encode::deserialize;

    fn test_segwit_sighash<V: Decodable + Encodable>(
        tx: &str,
        script: &str,
        input_index: usize,
        value: &str,
        ...
        let value: V = deserialize(&Vec::<u8>::from_hex(value).unwrap()[..]).unwrap();
    ...
    fn test_segwit_sighashes() {
        ...
        test_segwit_sighash::<ValueCommitment>("", "76a914f54a5851e9372b87810a8e60cdd2e7cfd80b6e3188ac", 0, "0850863ad64a87ae8a2fe83c1af1a8403cb53f53e486d8511dad8a04887e5b2352", SigHashType::All, "e201b4019129a03ca0304989731c6dccde232c854d86fce999b7411da1e90048");
        ...
        test_segwit_sighash::<ExplicitValue>("", "76a914f54a5851e9372b87810a8e60cdd2e7cfd80b6e3188ac", 0, "010000000005f5e100", SigHashType::All, "71141639d982f1a1a8901e32fb1a9e15a0ea168b37d33300a3c9619fc3767388");
        ...
        test_segwit_sighash::<ValueCommitment>("", "76a914f54a5851e9372b87810a8e60cdd2e7cfd80b6e3188ac", 0, "0850863ad64a87ae8a2fe83c1af1a8403cb53f53e486d8511dad8a04887e5b2352", SigHashType::All, "ea946ee417d5a16a1038b2c3b54d1b7b12a9f98c0dcb4684bf005eb1c27d0c92");
    }
